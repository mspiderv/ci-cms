...
class Page_With_TypeField extends SelectField implements IFormField, IFormFieldDynamic {
    ...
    function __construct($name = '', $title = '', $selected = NULL)
    {
        ...
        $this->CI->s_pages_model->where('page_type_id', '=', intval($params[0]));
        
        $this->options = $this->CI->s_pages_model->get_data_in_col('name');
