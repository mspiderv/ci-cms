...
CKEDITOR.dialog.add("link",function(n){
    ...
    if(typeof cms != 'undefined' && typeof cms.eshop != 'undefined' && cms.eshop)
    {
        var items = [
            [b.toUrl,"url"],
            [b.toAnchor,"anchor"],
            ...
            [b.toCmsPage,"cmsPage"],
            [b.toCmsProduct,"cmsProduct"],
            [b.toCmsCategory,"cmsCategory"],
            [b.toCmsService,"cmsService"],
    ...
    return{
        ...
        contents:[{
            ...
            elements:[{
                ...
                onChange:function(){
                    ...
                    "emailOptions"],c=this.getValue(),d=a.definition.getContents("upload"),d=d&&d.hidden;
                    if(c=="url"){
            ...
            
            {
                ...
                children:[{
                        ...
                        "default":"",
                        label:b.cmsPage,
                        items:cms.href_pages,
                        commit:function(a){
                            if(!a.anchor)a.anchor={};
                            var d=this.getDialog();
                            if(d.getContentElement("info","linkType")&&d.getValueOf("info","linkType")=="cmsPage")
                            a.anchor.val=this.getValue()
                        },
                        validate:function(){
                            var a=this.getDialog();
                            if(a.getContentElement("info","linkType")&&a.getValueOf("info","linkType")!="cmsPage")return true;
                        ...
                        commit:function(a){
                            ...
                            var d=this.getDialog();
                            if(d.getContentElement("info","linkType")&&d.getValueOf("info","linkType")=="cmsPage")
                            a.anchor.lang=this.getValue()
                        }
                    }]
            },{
                type:"hbox",
                id:"cmsProductOptions",
                widths:["50%", "50%"],
                align:"center",
                padding:0,
                children:[{
                        ...
                        "default":"",
                        label:b.cmsProduct,
                        items:cms.href_products,
                        commit:function(a){
                            if(!a.anchor)a.anchor={};
                            var d=this.getDialog();
                            if(d.getContentElement("info","linkType")&&d.getValueOf("info","linkType")=="cmsProduct")
                            a.anchor.val=this.getValue()
                        },
                        validate:function(){
                            var a=this.getDialog();
                            if(a.getContentElement("info","linkType")&&a.getValueOf("info","linkType")!="cmsProduct")return true;
                            return (this.getValue().length > 0)
                        }
                    },{
                        type:"select",
                ...
                children:[{
                        ...
                        "default":"",
                        label:b.cmsProduct,
                        items:cms.href_product_categories,
                        commit:function(a){
                            if(!a.anchor)a.anchor={};
                            var d=this.getDialog();
                            if(d.getContentElement("info","linkType")&&d.getValueOf("info","linkType")=="cmsCategory")
                            a.anchor.val=this.getValue()
                        },
                        validate:function(){
                            var a=this.getDialog();
                            if(a.getContentElement("info","linkType")&&a.getValueOf("info","linkType")!="cmsCategory")return true;
                            return (this.getValue().length > 0)
                        }
                    },{
                        type:"select",
                ...
                children:[{
                        ...
                        "default":"",
                        label:b.cmsService,
                        items:cms.href_services,
                        commit:function(a){
                            if(!a.anchor)a.anchor={};
                            var d=this.getDialog();
                            if(d.getContentElement("info","linkType")&&d.getValueOf("info","linkType")=="cmsService")
                            a.anchor.val=this.getValue()
                        },
                        validate:function(){
                            var a=this.getDialog();
                            if(a.getContentElement("info","linkType")&&a.getValueOf("info","linkType")!="cmsService")return true;
                            return (this.getValue().length > 0)
                        }
                    },{
                        type:"select",
        ...
        onOk:function(){
            ...
            switch(c.type||"url"){
                ...
                case "cmsCategory":
                case "cmsService":
                    a["data-cke-saved-href"]="{"+c.anchor.val+(c.anchor.lang.length>0?":"+c.anchor.lang:"")+"}";
                    break;
